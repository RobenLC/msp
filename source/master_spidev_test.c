...
#define RING_BUFF_NUM   (128)//(6000/4) //(1024)
...
static int usb_host(struct usbhost_s *puhs, char *strpath)
{
    ...
    char ptfilepath[128];
#endif
    char cmdMtx[8][2] = {{'m', 0x01},{'d', 0x02},{'a', 0x03},{'s', 0x02},{'p', 0x03},
    					    {'q', 0x02},{'r', 0x03},{'g', 0x05}};
    uint8_t cmdchr=0;
