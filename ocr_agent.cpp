...
extern "C" void *BKOCR_Check3( void * img_buf, int img_size, char *out_buf, int buf_size )
{
    static void *p_model=NULL;
...
extern "C" void *BKOCR_Check4( void * img_buf, int img_size, char *out_buf, int buf_size )
{
    static void *p_model=NULL;
...
extern "C" void *ocr_agent_start( void * arg )
{
    ...
    for( i1=1; i1< param->argc; i1++ )
    {
        ...
        do
        {
            ...
            bkocr( img_buf, img_size,ocr_result, 20, p_model);
            free( img_buf );
